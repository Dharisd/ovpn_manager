...
class OVCCG:
    ...
    def __init__(self, runtime_vars):
        ...
        self.__config_save_path = self.__config.get('save_path', 'configs/').rstrip('/')
    ...
    def __prepare_ovpn_config_object(self, certs):
        ...
        if self.__config.get("extra_vars"):
        ...
        config_lines.append('cipher AES-128-GCM')
        config_lines.append('tls-client')
        config_lines.append('tls-version-min 1.2')
        config_lines.append('tls-cipher TLS-ECDHE-ECDSA-WITH-AES-128-GCM-SHA256')
        config_lines.append('ignore-unknown-option block-outside-dns')
    ...
    def __prepare_certs(self, user_data):
        ...
        config_data = {
            ...
            'ca_crt_path': self.__config.get('ca_cert_path', '/etc/openvpn/ca.crt'),
            'ca_key_path': self.__config.get('ca_key_path', '/etc/openvpn/ca.key'),
        }
